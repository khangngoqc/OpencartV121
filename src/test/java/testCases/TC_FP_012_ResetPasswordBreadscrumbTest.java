...
public class TC_FP_012_ResetPasswordBreadscrumbTest extends BaseClass {

	@Test(alwaysRun = false, dependsOnGroups = {"init_password"}, groups = { "master", "forgot password" })
	public void reset_password_Breadscrumb_validate() throws IOException, MailosaurException {

		logger.info("******* Starting TC_FP_012_ResetPasswordBreadscrumbTest *******");
		...
		logger.info("******* Finished TC_FP_012_ResetPasswordBreadscrumbTest *******");
