...
public class TC_FP_002_ResetPasswordEmailTest extends BaseClass {

	@Test(alwaysRun = false, dependsOnGroups = {"init_password"}, groups = { "master", "forgot password" })
	void validate_reset_password_email() throws IOException, MailosaurException {

		logger.info("******* Starting TC_FP_002_ResetPasswordEmailLinkTest *******");
