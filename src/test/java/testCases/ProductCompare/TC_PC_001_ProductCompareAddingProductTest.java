...
public class TC_PC_001_ProductCompareAddingProductTest extends BaseClass{
	
	String searchInput = "iMac";
	
	@Test(groups = {"product compare", "master"})
	void adding_product_to_compare() {
		
		logger.info("***Starting TC_PC_001_ProductCompareAddingProductTest ***");
