...
public class TC_LF_005_NoncredentialLoginTest extends BaseClass {

	@Test(groups = { "login", "master", "functionality" })
	public void verify_login_without_credentials() {
		logger.info("***Starting TC_LF_005_NoncredentialLoginTest ***");
		...
		try {
			...
			// validation
			Assert.assertEquals(targetPage, false, "Login bypassed with without credentials.");
		...
		logger.info("***Finished TC_LF_005_NoncredentialLoginTest ***");
