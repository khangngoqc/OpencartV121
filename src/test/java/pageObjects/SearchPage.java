...
public class SearchPage extends BasePage {
	...
	@FindBy(xpath = "//p[@class='price']") List<WebElement> searchProductPrices;
	...
	public boolean isProductTitlesSortedAtoZ(){
		return isSortedAtoZ(searchProductTitles);
	}
	...
	public boolean isProductPriceSortedHightoLow(){
		return isSortedHightoLow(searchProductTitles);
	}
	...
	private boolean isSortedAtoZ(List<WebElement> list) {
